...
begin --ulopoiw to block diagram ths anaforas
	...
	U1:csa_gen10and14bit generic map (n=>13) port map (a(15 downto 2),b(13 downto 0),'0',s0(13 downto 0),open); 
	U2:csa_gen10and14bit generic map (n=>9) port map (c(11 downto 2),d(9 downto 0),'0',s1(11 downto 2),open); 
	...
	V1:csa_gen12bit generic map (n=>11) port map (s0(13 downto 2),s1(11 downto 0),'0',s(15 downto 4),open);
